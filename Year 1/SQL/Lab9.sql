-- Run command: @H:\comp155\labsol\Lab9
...
set echo on
SPOOL H:\comp155\labsol\Lab9_Sol.txt
set pagesize 50
...
INSERT INTO customers (
  customer_id, first_name, last_name, dob, phone 
	...
	50, 'Grace', 'Hopper', TO_DATE('December 9, 1906', 'mm-dd-yy'), '800-555-1250' ); 
INSERT INTO customers (
  customer_id, first_name, last_name, dob, phone 
) VALUES (
	51, 'Steve', 'Jobs', TO_DATE('February 24, 1955', 'mm-dd-yy'), '800-555-1251' );
INSERT INTO customers (
  customer_id, first_name, last_name, dob, phone 
) VALUES (
	52, 'Larry', 'Ellison', TO_DATE('August 17, 1944', 'mm-dd-yy'), '800-555-1252' ); 
INSERT INTO customers (
  customer_id, first_name, last_name, dob, phone 
) VALUES (
	53, 'Tom', 'Thomson', TO_DATE('August 4, 1877', 'mm-dd-yy'), NULL ); 
...
INSERT INTO customers (
  ...
  154, 'Tyler', 'Francis', TO_DATE('January 1, 1000', 'mm-dd-yy'), '250-666-6666');
...
ROLLBACK to CUST_SAVEP;
/* The commit deletes the save points and does all the changes since the last commit. */
/*** 18 List contents ***/
...
TO_CHAR(dob, 'Month DD, YYYY') AS "dob", phone
FROM customers;
